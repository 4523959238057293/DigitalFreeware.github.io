...
defaultOptions.ui.popoverError = function (errors) {
    "use strict";
    var message = "<div>Errors:<div class='error-list' style='margin-bottom: 0;'>";
...
(function ($, ui) {
    ...
    var barClasses = ["bg-danger", "bg-warning", "bg-success"],
        statusClasses = ["error", "bg-warning", "bg-success"];
    ...
    ui.getUIElements = function (options, $el) {
        ...
        if (!options.ui.showPopover) {
            ...
            result.$errors = ui.findElement($container, options.ui.viewports.errors, "div.error-list");
        }
    ...
    ui.initErrorList = function (options, $el) {
        ui.initHelper(options, $el, "<div class='error-list'></div>",
